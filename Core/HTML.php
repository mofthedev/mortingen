...
class HTML
{
    ...
    public static function br(array $attributes = []): View { return static::createVoidElement('br', $attributes); }
    public static function col(array $attributes = []): View { return static::createVoidElement('col', $attributes); }
    public static function embed(array $attributes = []): View { return static::createVoidElement('embed', $attributes); }
    public static function hr(array $attributes = []): View { return static::createVoidElement('hr', $attributes); }
    public static function img(array $attributes = []): View { return static::createVoidElement('img', $attributes); }
    public static function input(array $attributes = []): View { return static::createVoidElement('input', $attributes); }
    public static function link(array $attributes = []): View { return static::createVoidElement('link', $attributes); }
    public static function meta(array $attributes = []): View { return static::createVoidElement('meta', $attributes); }
    public static function param(array $attributes = []): View { return static::createVoidElement('param', $attributes); }
    public static function source(array $attributes = []): View { return static::createVoidElement('source', $attributes); }
    public static function track(array $attributes = []): View { return static::createVoidElement('track', $attributes); }
    public static function wbr(array $attributes = []): View { return static::createVoidElement('wbr', $attributes); }
}