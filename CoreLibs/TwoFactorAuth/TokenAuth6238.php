...
class TokenAuth6238
{
    ...
    public static function getBarCodeUrl($username, $domain, $secretkey, $issuer)
    {
        ...
        // "otpauth://totp/".$username . "@" . $domain . "?secret=" . $secretkey . '&issuer=' . $issuer
    ...
    public static function generateRandomClue($length = 16)
    {
        ...
        for ($i = 0; $i < $length; $i++)
            // $s .= $b32[rand(0,31)]; // This is not secure for PHP versions lower than 7.1. Let's change it to random_int() from now on.
